...
import com.jaceed.android.magicdialog.utils.enumOf
            ...
            findViewById<ImageView>(R.id.magic_prompt_pic)?.let { pic ->
                pic.visible = (arguments?.getParcelable(ARG_PIC) as? Bitmap)?.let {
                    ...
                    arguments?.getParcelable<Uri>(ARG_PIC_URI)?.let {
                        pic.load(it) {
                            placeholder(R.drawable.ic_prompt_pic_placeholder)
                            error(R.drawable.ic_prompt_pic_error)
                        }
                        true
                    } ?: false
                }
